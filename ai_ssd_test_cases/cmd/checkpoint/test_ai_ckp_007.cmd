@echo off
REM ==============================================================================
REM  AI-CKP-007 :: 1T full distributed (native)
REM  model = llama3-1t  |  accelerator = A100  |  data_format = ckpt  |  capacity ~ 198656 GiB
REM  execution = native  |  destructive = True  |  family = checkpoint
REM  expected blocker: destructive: needs 194 TiB on DUT; --confirm-dut required
REM
