@echo off
REM ==============================================================================
REM  AI-CKP-006 :: 1T subset save/load (native)
REM  model = llama3-1t  |  accelerator = A100  |  data_format = ckpt  |  capacity ~ 11392 GiB
REM  execution = native  |  destructive = True  |  family = checkpoint
REM  expected blocker: destructive: needs 11 TiB on DUT; --confirm-dut required
REM
