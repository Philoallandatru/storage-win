@echo off
REM ==============================================================================
REM  AI-CKP-001 :: 8B full baseline save/load (native)
REM  model = llama3-8b  |  accelerator = A100  |  data_format = ckpt  |  capacity ~ 840 GiB
REM  execution = native  |  destructive = True  |  family = checkpoint
REM  expected blocker: destructive: needs 840 GiB on DUT; --confirm-dut required
REM
