@echo off
REM ==============================================================================
REM  AI-CKP-003 :: 70B full (64 rank) 并行 (native)
REM  model = llama3-70b  |  accelerator = A100  |  data_format = ckpt  |  capacity ~ 58368 GiB
REM  execution = native  |  destructive = True  |  family = checkpoint
REM  expected blocker: destructive: needs 57 TiB on DUT; --confirm-dut required
REM
