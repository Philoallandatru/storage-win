@echo off
REM =============================================================================
REM  AI-CKP-005 :: 405B 全量 shared storage save/load（native，破坏性）
REM  model = llama3-405b  |  accelerator = A100  |  data_format = ckpt  |  容量 ~ 57344 GiB
...
REM    ai_ssd_test_cases\cmd\checkpoint\test_ai_ckp_005.cmd
REM ============================================================================
