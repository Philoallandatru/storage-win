@echo off
REM =============================================================================
REM  AI-MIX-001 :: 训练 + Checkpoint save 并发（python_scaled，破坏性）
REM  model = training-checkpoint  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\mixed\test_ai_mix_001.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_mixed_training_checkpoint ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
