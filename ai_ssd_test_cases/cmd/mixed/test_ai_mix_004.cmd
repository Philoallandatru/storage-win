@echo off
REM =============================================================================
REM  AI-MIX-004 :: KV 交互 + VDB search 并发（python_scaled，破坏性）
REM  model = kv-interactive-vdb-search  |  容量 ~ 1 GiB
REM  执行方式 = python_scaled（Python 缩放兜底）  |  破坏性 = 是（破坏性，必须 --confirm-dut）  |  家族 = mixed（混合负载）
REM  预期阻塞：破坏性；需要 Milvus；必须 --confirm-dut + --scale-mb
REM
...
REM    ai_ssd_test_cases\cmd\mixed\test_ai_mix_004.cmd
REM ============================================================================
