@echo off
REM ==============================================================================
REM  AI-VDB-011 :: batch 1..64 扫 (native)
REM  model = search-batch-scaling  |  accelerator = *  |  data_format = vdb  |  capacity ~ 30 GiB
REM  execution = native  |  destructive = False  |  family = vectordb
REM  expected blocker: native: mlpstorage open vectordb search-batch scaling
REM
...
"%PY%" -m ai_ssd_test_cases.test_vdb_search_batch_scaling ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute
set RC=%ERRORLEVEL%
