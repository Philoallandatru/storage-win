@echo off
REM ==============================================================================
REM  AI-VDB-010 :: query proc 1..16 扫 (native)
REM  model = query-proc-scaling  |  accelerator = *  |  data_format = vdb  |  capacity ~ 30 GiB
REM  execution = native  |  destructive = False  |  family = vectordb
REM  expected blocker: native: mlpstorage open vectordb query-process scaling
REM
...
"%PY%" -m ai_ssd_test_cases.test_vdb_query_process_scaling ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute
set RC=%ERRORLEVEL%
