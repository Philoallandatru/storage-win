@echo off
REM ==============================================================================
REM  AI-VDB-004 :: 1M DISKANN 512D (native)
REM  model = diskann-1m-512  |  accelerator = *  |  data_format = vdb  |  capacity ~ 10 GiB
REM  execution = native  |  destructive = False  |  family = vectordb
REM  expected blocker: native: mlpstorage open vectordb diskann search file (1M 512D)
REM
