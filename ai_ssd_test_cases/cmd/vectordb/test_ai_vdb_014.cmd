@echo off
REM =============================================================================
REM  AI-VDB-014 :: 冷热 search 对比（native）
REM  model = cold-warm-search  |  data_format = vdb  |  容量 ~ 30 GiB
...
REM    ai_ssd_test_cases\cmd\vectordb\test_ai_vdb_014.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_vdb_cold_warm_search ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute
set RC=%ERRORLEVEL%
