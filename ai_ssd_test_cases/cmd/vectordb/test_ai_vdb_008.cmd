@echo off
REM ==============================================================================
REM  AI-VDB-008 :: index 族扫 (native)
REM  model = index-family-sweep  |  accelerator = *  |  data_format = vdb  |  capacity ~ 30 GiB
REM  execution = native  |  destructive = False  |  family = vectordb
REM  expected blocker: native: mlpstorage open vectordb index-family sweep
REM
...
"%PY%" -m ai_ssd_test_cases.test_vdb_index_family_sweep ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute
set RC=%ERRORLEVEL%
