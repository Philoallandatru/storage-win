...
REM  model = unet3d  |  accelerator = A100  |  data_format = npz  |  容量 ~22.9 GiB（原生数据集）
REM  执行方式 = native_special（特殊路径原生命令）  |  破坏性 = 否  |  家族 = training（训练）
REM  预期阻塞：需要 DUT 上有 22.9 GiB 空间；需先 mlpstorage init + native datagen
REM
...
REM    ai_ssd_test_cases\cmd\training\test_ai_trn_001.cmd
REM ============================================================================
