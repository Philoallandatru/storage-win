@echo off
REM =============================================================================
REM  AI-TRN-006 :: CosmoFlow A100 TFRecord 训练（python_scaled）
REM  model = cosmoflow  |  accelerator = A100  |  data_format = tfrecord  |  容量 ~1.3 TiB（原生数据集）
...
REM    ai_ssd_test_cases\cmd\training\test_ai_trn_006.cmd
REM ============================================================================
