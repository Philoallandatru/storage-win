@echo off
REM =============================================================================
REM  AI-TRN-013 :: Flux MI355 Parquet 训练（python_scaled）
REM  model = flux  |  accelerator = MI355  |  data_format = parquet  |  容量 ~? GiB（yaml 无 record_length）
...
REM    ai_ssd_test_cases\cmd\training\test_ai_trn_013.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_ai_trn_013_flux_mi355_parquet ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
