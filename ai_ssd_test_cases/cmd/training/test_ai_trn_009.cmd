@echo off
REM =============================================================================
REM  AI-TRN-009 :: ResNet50 H100 TFRecord 训练（python_scaled）
REM  model = resnet50  |  accelerator = H100  |  data_format = tfrecord  |  容量 ~136.8 GiB（原生数据集）
...
REM    ai_ssd_test_cases\cmd\training\test_ai_trn_009.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_ai_trn_009_resnet50_h100_tfrecord ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
