@echo off
REM ==============================================================================
REM  AI-TRN-015 :: 读线程 1..32 扫 (python_scaled)
REM  model = read-threads-saturation  |  accelerator = *  |  data_format = mixed  |  capacity ~ 1 GiB
REM  execution = python_scaled  |  destructive = False  |  family = training
REM  expected blocker: python_scaled single-point; read_threads sweep not reproduced
REM
