@echo off
REM ==============================================================================
REM  AI-TRN-007 :: CosmoFlow H100 TFRecord (python_scaled)
REM  model = cosmoflow  |  accelerator = H100  |  data_format = tfrecord  |  capacity ~ 1 GiB
...
"%PY%" -m ai_ssd_test_cases.test_ai_trn_007_cosmoflow_h100_tfrecord ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
