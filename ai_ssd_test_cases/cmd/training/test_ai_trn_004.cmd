...
REM  model = retinanet  |  accelerator = B200  |  data_format = jpeg  |  capacity ~ 351.6 GiB
REM  execution = native  |  destructive = False  |  family = training
REM  expected blocker: needs ~352 GiB on DUT; Windows multiprocessing fork is first blocker
REM
