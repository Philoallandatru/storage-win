@echo off
REM =============================================================================
REM  AI-TRN-011 :: DLRM MI355 Parquet 训练（python_scaled）
REM  model = dlrm  |  accelerator = MI355  |  data_format = parquet  |  容量 ~1.1 TiB（原生数据集）
...
REM    ai_ssd_test_cases\cmd\training\test_ai_trn_011.cmd
REM ============================================================================
