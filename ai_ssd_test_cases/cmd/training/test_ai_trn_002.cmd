@echo off
REM ==============================================================================
REM  AI-TRN-002 :: UNet3D H100 compute-gap 后回归 (python_scaled)
REM  model = unet3d  |  accelerator = H100  |  data_format = npz  |  capacity ~ 22.9 GiB
REM  execution = python_scaled  |  destructive = False  |  family = training
REM  expected blocker: python_scaled fallback; --scale-mb required (default 1024)
REM
