@echo off
REM =============================================================================
REM  AI-TRN-010 :: DLRM B200 Parquet 训练（python_scaled）
REM  model = dlrm  |  accelerator = B200  |  data_format = parquet  |  容量 ~1.1 TiB（原生数据集）
...
REM    ai_ssd_test_cases\cmd\training\test_ai_trn_010.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_ai_trn_010_dlrm_b200_parquet ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
