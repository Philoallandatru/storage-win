@echo off
REM =============================================================================
REM  AI-TRN-012 :: Flux B200 Parquet 训练（python_scaled）
REM  model = flux  |  accelerator = B200  |  data_format = parquet  |  容量 ~? GiB（yaml 无 record_length）
...
REM    ai_ssd_test_cases\cmd\training\test_ai_trn_012.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_ai_trn_012_flux_b200_parquet ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
