@echo off
REM =============================================================================
REM  AI-KV-014 :: 张量并行矩阵（python_scaled）
REM  model = tensor-parallel  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_014.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_tensor_parallel_matrix ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
