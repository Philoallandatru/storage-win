@echo off
REM =============================================================================
REM  AI-KV-012 :: GPT-OSS 120B（python_scaled）
REM  model = gpt-oss-120b  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_012.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_gpt_oss_120b ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
