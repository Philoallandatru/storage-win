@echo off
REM =============================================================================
REM  AI-KV-019 :: RAG prefix 多轮（python_scaled）
REM  model = rag-prefix-multi  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_019.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_rag_prefix_multiturn ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
