@echo off
REM ==============================================================================
REM  AI-KV-004 :: 1B smoke 烟囱 (native)
REM  model = tiny1b-smoke  |  accelerator = A100  |  data_format = kv  |  capacity ~ 1 GiB
REM  execution = native  |  destructive = False  |  family = kvcache
REM  expected blocker: native: mlpstorage open kvcache tiny-1b run (smoke)
REM
...
"%PY%" -m ai_ssd_test_cases.test_kv_tiny1b_smoke ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute
set RC=%ERRORLEVEL%
