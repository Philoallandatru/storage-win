@echo off
REM =============================================================================
REM  AI-KV-016 :: Decode 读（python_scaled）
REM  model = decode-read  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_016.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_decode_read ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
