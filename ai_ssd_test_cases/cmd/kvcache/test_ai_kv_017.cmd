@echo off
REM =============================================================================
REM  AI-KV-017 :: 场景 personas（python_scaled）
REM  model = context-personas  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_017.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_context_personas ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
