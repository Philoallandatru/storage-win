@echo off
REM =============================================================================
REM  AI-KV-001 :: 8B NVMe-only 阶段（native）
REM  model = option1-8b-nvme  |  accelerator = A100  |  data_format = kv  |  容量 ~ 1 GiB
REM  执行方式 = native（原生 mlpstorage 命令）  |  破坏性 = 否  |  家族 = KV Cache
REM  预期阻塞：mlpstorage open kvcache llama3-8b run
REM
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_001.cmd
REM ============================================================================
