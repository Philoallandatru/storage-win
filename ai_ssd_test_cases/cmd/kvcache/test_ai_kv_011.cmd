@echo off
REM =============================================================================
REM  AI-KV-011 :: GPT-OSS 20B MoE（python_scaled）
REM  model = gpt-oss-20b-moe  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_011.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_gpt_oss_20b_moe ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
