@echo off
REM =============================================================================
REM  AI-KV-018 :: 生成模式（python_scaled）
REM  model = generation-modes  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_018.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_generation_modes ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
