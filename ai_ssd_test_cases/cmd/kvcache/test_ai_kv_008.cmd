@echo off
REM ==============================================================================
REM  AI-KV-008 :: LLaMA3.1 70B 用户扫 (native)
REM  model = llama31-70b-users  |  accelerator = A100  |  data_format = kv  |  capacity ~ 1 GiB
REM  execution = native  |  destructive = False  |  family = kvcache
REM  expected blocker: native: mlpstorage open kvcache llama3.1-70b run
REM
