@echo off
REM =============================================================================
REM  AI-KV-010 :: Qwen3 32B sweep（python_scaled）
REM  model = qwen3-32b-sweep  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_010.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_qwen3_32b_sweep ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
