@echo off
REM =============================================================================
REM  AI-KV-022 :: BurstGPT / ShareGPT（python_scaled）
REM  model = burstgpt-sharegpt  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_022.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_burstgpt_sharegpt ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
