@echo off
REM =============================================================================
REM  AI-KV-020 :: 饱和度自伸缩（python_scaled）
REM  model = saturation-auto  |  data_format = kv  |  容量 ~ 1 GiB
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_020.cmd
REM ============================================================================
...
"%PY%" -m ai_ssd_test_cases.test_kv_saturation_autoscale ^
    --data-dir "%DUT%" ^
    --result-dir "%RES%" ^
    --execute ^
    --scale-mb ^
