@echo off
REM =============================================================================
REM  AI-KV-006 :: Llama2 7B upper bound（native）
REM  model = llama2-7b-upper  |  accelerator = A100  |  data_format = kv  |  容量 ~ 1 GiB
REM  执行方式 = native（原生 mlpstorage 命令）  |  破坏性 = 否  |  家族 = KV Cache
REM  预期阻塞：Llama2 7B 容量上限
REM
...
REM    ai_ssd_test_cases\cmd\kvcache\test_ai_kv_006.cmd
REM ============================================================================
