r"""Wrapper for AI-TRN-013 — Flux / MI355, python_scaled, 1.0 GiB dataset.

Original xlsx row: 13 (Training Case表).

xlsx 不合理（已在 wrapper 里修正）:
  catalog 标 python_scaled；'长 compute gap 后突发读取'在 Python 缩版下不能复现
...
Usage::
    ...
    .venv\Scripts\python.exe ai_ssd_test_cases\training\test_training_ai_trn_013_flux-mi355-parquet.py ^
