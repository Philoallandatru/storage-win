r"""Wrapper for AI-TRN-009 — ResNet50 / H100, python_scaled, 1.0 GiB dataset.

Original xlsx row: 9 (Training Case表).

xlsx 不合理（已在 wrapper 里修正）:
  catalog 标 python_scaled；'workers 1..8 sweep' 在 Python 缩版下不能复现
...
Usage::
    ...
    .venv\Scripts\python.exe ai_ssd_test_cases\training\test_training_ai_trn_009_resnet50-h100-tfrecord.py ^
