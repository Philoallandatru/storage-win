r"""Wrapper for AI-TRN-011 — DLRM / MI355, python_scaled, 1.0 GiB dataset.

Original xlsx row: 11 (Training Case表).

xlsx 不合理（已在 wrapper 里修正）:
  catalog 标 python_scaled；'read_threads 1/4/8/16 sweep' 在 Python 缩版下不能复现
...
Usage::
    ...
    .venv\Scripts\python.exe ai_ssd_test_cases\training\test_training_ai_trn_011_dlrm-mi355-parquet.py ^
