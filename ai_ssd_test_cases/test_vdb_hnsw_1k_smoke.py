"""FULL_TEST_PLAN Case 052: AI-VDB-001.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['open', 'vectordb', 'datagen', 'file', '--vdb-engine', 'milvus', '--vdb-index', 'HNSW', '--host', '127.0.0.1', '--port', '19530', '--collection', 'ai_vdb_001_hnsw', '--num-vectors', '1000', '--dimension', '128', '--num-shards', '1', '--force', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>']}, {'phase': 'run', 'argv': ['open', 'vectordb', 'run', 'file', '--vdb-engine', 'milvus', '--vdb-index', 'HNSW', '--host', '127.0.0.1', '--port', '19530', '--collection', 'ai_vdb_001_hnsw', '--benchmark-mode', 'timed', '--vector-dim', '128', '--num-query-processes', '<QUERY_PROCESSES>', '--runtime', '<DURATION_SEC>', '--loops', '<LOOPS>', '--storage-root', '<STORAGE_ROOT>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>']}]
