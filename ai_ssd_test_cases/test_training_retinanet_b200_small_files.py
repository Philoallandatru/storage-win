"""FULL_TEST_PLAN Case 008: AI-TRN-004.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['open', 'training', 'retinanet', 'datagen', 'file', '--num-processes', '1', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=1170301']}, {'phase': 'run', 'argv': ['open', 'training', 'retinanet', 'run', 'file', '--num-accelerators', '<ACCELERATORS>', '--accelerator-type', 'b200', '--client-host-memory-in-gb', '<CLIENT_MEMORY_GB>', '--loops', '<LOOPS>', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=1170301']}]
