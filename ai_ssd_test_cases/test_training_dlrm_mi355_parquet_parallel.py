"""FULL_TEST_PLAN Case 015: AI-TRN-011.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['whatif', 'training', 'dlrm', 'datagen', 'file', '--num-processes', '1', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>']}, {'phase': 'run', 'argv': ['whatif', 'training', 'dlrm', 'run', 'file', '--num-accelerators', '<ACCELERATORS>', '--accelerator-type', 'mi355', '--client-host-memory-in-gb', '<CLIENT_MEMORY_GB>', '--loops', '<LOOPS>', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>']}]
