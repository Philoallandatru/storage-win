"""FULL_TEST_PLAN Case 007: AI-TRN-003.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['open', 'training', 'unet3d', 'datagen', 'file', '--num-processes', '1', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=7200']}, {'phase': 'run', 'argv': ['open', 'training', 'unet3d', 'run', 'file', '--num-accelerators', '<ACCELERATORS>', '--accelerator-type', 'b200', '--client-host-memory-in-gb', '<CLIENT_MEMORY_GB>', '--loops', '<LOOPS>', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=7200']}]
