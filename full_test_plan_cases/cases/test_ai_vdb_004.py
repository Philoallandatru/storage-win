"""FULL_TEST_PLAN Case 055: AI-VDB-004.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['open', 'vectordb', 'datagen', 'file', '--vdb-engine', 'milvus', '--vdb-index', 'DISKANN', '--host', '127.0.0.1', '--port', '19530', '--collection', 'ai_vdb_004_diskann', '--num-vectors', '1000000', '--dimension', '512', '--num-shards', '1', '--force', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>']}, {'phase': 'run', 'argv': ['open', 'vectordb', 'run', 'file', '--vdb-engine', 'milvus', '--vdb-index', 'DISKANN', '--host', '127.0.0.1', '--port', '19530', '--collection', 'ai_vdb_004_diskann', '--benchmark-mode', 'timed', '--vector-dim', '512', '--num-query-processes', '<QUERY_PROCESSES>', '--runtime', '<DURATION_SEC>', '--loops', '<LOOPS>', '--storage-root', '<STORAGE_ROOT>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>']}]
