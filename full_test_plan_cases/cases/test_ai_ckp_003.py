...
COMMANDS = [{'phase': 'run', 'argv': ['open', 'checkpointing', 'run', 'file', '--model', 'llama3-70b', '--num-processes', '64', '--client-host-memory-in-gb', '<CLIENT_MEMORY_GB>', '--checkpoint-folder', '<CHECKPOINT_DIR>', '--num-checkpoints-read', '10', '--num-checkpoints-write', '10', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>']}]
