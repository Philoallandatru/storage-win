"""FULL_TEST_PLAN Case 017: AI-TRN-013.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['whatif', 'training', 'flux', 'datagen', 'file', '--num-processes', '1', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=4296']}, {'phase': 'run', 'argv': ['whatif', 'training', 'flux', 'run', 'file', '--num-accelerators', '<ACCELERATORS>', '--accelerator-type', 'mi355', '--client-host-memory-in-gb', '<CLIENT_MEMORY_GB>', '--loops', '<LOOPS>', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=4296']}]
