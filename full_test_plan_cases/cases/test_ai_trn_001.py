"""FULL_TEST_PLAN Case 005: AI-TRN-001.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['whatif', 'training', 'unet3d', 'datagen', 'file', '--num-processes', '1', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=168']}, {'phase': 'run', 'argv': ['whatif', 'training', 'unet3d', 'run', 'file', '--num-accelerators', '<ACCELERATORS>', '--accelerator-type', 'a100', '--client-host-memory-in-gb', '<CLIENT_MEMORY_GB>', '--loops', '<LOOPS>', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=168']}]
