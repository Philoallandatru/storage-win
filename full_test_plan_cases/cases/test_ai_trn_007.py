"""FULL_TEST_PLAN Case 011: AI-TRN-007.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['whatif', 'training', 'cosmoflow', 'datagen', 'file', '--num-processes', '1', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=524288']}, {'phase': 'run', 'argv': ['whatif', 'training', 'cosmoflow', 'run', 'file', '--num-accelerators', '<ACCELERATORS>', '--accelerator-type', 'h100', '--client-host-memory-in-gb', '<CLIENT_MEMORY_GB>', '--loops', '<LOOPS>', '--data-dir', '<DATA_DIR>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>', '--exec-type', 'mpi', '--mpi-bin', '<MPI_BIN>', '--params', 'dataset.num_files_train=524288']}]
