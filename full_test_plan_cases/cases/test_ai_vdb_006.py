"""FULL_TEST_PLAN Case 057: AI-VDB-006.
...
COMMANDS = [{'phase': 'prepare', 'argv': ['open', 'vectordb', 'datagen', 'file', '--vdb-engine', 'milvus', '--vdb-index', 'HNSW', '--host', '127.0.0.1', '--port', '19530', '--collection', 'ai_vdb_006_hnsw', '--num-vectors', '10000000', '--dimension', '1536', '--num-shards', '1', '--force', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>']}, {'phase': 'run', 'argv': ['open', 'vectordb', 'run', 'file', '--vdb-engine', 'milvus', '--vdb-index', 'HNSW', '--host', '127.0.0.1', '--port', '19530', '--collection', 'ai_vdb_006_hnsw', '--benchmark-mode', 'timed', '--vector-dim', '1536', '--num-query-processes', '<QUERY_PROCESSES>', '--runtime', '<DURATION_SEC>', '--loops', '<LOOPS>', '--storage-root', '<STORAGE_ROOT>', '--results-dir', '<RESULTS_DIR>', '--systemname', '<SYSTEMNAME>']}]
