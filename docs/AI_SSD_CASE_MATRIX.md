...
|---|---|---|---|
| Training（8 文件 / 压力 100-2000 文件） | 1m44s ~ 4m46s | 预计 10-30 分钟（写 40-120GB） | 充足 |
| Checkpoint（1 写 1 读 / 压力 3 写 3 读） | ~1-5 分钟 | 预计 10-20 分钟（写 ~340GB） | 充足 |
| KV Cache（10 users×10s / 压力 50 users×60s） | 9m44s ~ 10m29s | 预计 10-15 分钟（持续 spill） | 充足 |
| VectorDB（100 向量 / 压力 10K 向量×60s） | ~32s | 实测 81s | 充足 |
