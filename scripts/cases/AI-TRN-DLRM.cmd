...
"%PY%" -m full_test_plan_cases.run_case AI-TRN-DLRM --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-trn-dlrm --num-files-train 8 --allow-invalid-params --exec-type single --client-memory-gb 64
set "RC=%ERRORLEVEL%"
