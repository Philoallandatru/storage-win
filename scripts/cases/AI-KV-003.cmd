@echo off
REM ============================================================
REM  AI-KV-003  MLPerf option 3 Llama3.1-70B  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-KV-003"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-KV-003"
...
"%PY%" -m full_test_plan_cases.run_case AI-KV-003 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-kv-003 --num-users 10 --duration-sec 10 --trials 1 --inter-option-delay 0 --generation-mode fast --cpu-mem-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
