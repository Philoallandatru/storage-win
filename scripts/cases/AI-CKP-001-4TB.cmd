@echo off
REM ============================================================
REM  AI-CKP-001-4TB  Llama3-8B full 8 ranks  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-CKP-001-4TB"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-CKP-001-4TB"
...
"%PY%" -m full_test_plan_cases.run_case AI-CKP-001-4TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-001-4tb --num-processes 8 --allow-invalid-params --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
