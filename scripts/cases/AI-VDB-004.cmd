@echo off
REM ============================================================
REM  AI-VDB-004  DISKANN  - run this script directly
...
"%PY%" -m full_test_plan_cases.run_case AI-VDB-004 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-vdb-004 %EXTRA%
set "RC=%ERRORLEVEL%"
endlocal & exit /b %RC%
