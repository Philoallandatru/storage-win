@echo off
REM ============================================================
REM  AI-CKP-006  Llama3-1T 8-rank subset  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-CKP-006"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-CKP-006"
...
"%PY%" -m full_test_plan_cases.run_case AI-CKP-006 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-006 --num-processes 8 --allow-invalid-params --num-checkpoints-write 1 --num-checkpoints-read 1 --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
