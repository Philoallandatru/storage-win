...
set "DATA_DIR=G:\MLPerfStorageTest\data\AI-KV-002"
set "RESULT_DIR=D:\MLPerfStorageTest\results\AI-KV-002"

echo [%~n0] data-dir=%DATA_DIR%  results-dir=%RESULT_DIR%
"%PY%" -m full_test_plan_cases.run_case AI-KV-002 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-kv-002 --num-users 10 --duration-sec 10 --trials 1 --inter-option-delay 0 --generation-mode fast --cpu-mem-gb 64
set "RC=%ERRORLEVEL%"
