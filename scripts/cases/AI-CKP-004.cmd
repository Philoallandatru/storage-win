@echo off
REM ============================================================
REM  AI-CKP-004  Llama3-405B 8-rank subset  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-CKP-004"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-CKP-004"
...
"%PY%" -m full_test_plan_cases.run_case AI-CKP-004 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-004 --num-processes 8 --allow-invalid-params --num-checkpoints-write 1 --num-checkpoints-read 1 --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
