@echo off
REM ============================================================
REM  AI-CKP-007  llama3-1t  - run this script directly
...
"%PY%" -m full_test_plan_cases.run_case AI-CKP-007 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-007 %EXTRA%
set "RC=%ERRORLEVEL%"
endlocal & exit /b %RC%
