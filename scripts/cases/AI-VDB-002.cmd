@echo off
REM ============================================================
REM  AI-VDB-002  1Mx1536 HNSW  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-VDB-002"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-VDB-002"
...
"%PY%" -m full_test_plan_cases.run_case AI-VDB-002 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-vdb-002 --num-vectors 100 --duration-sec 10 --vdb-config C:\Users\Administrator\Documents\Code\repos\storage\full_test_plan_cases\configs\vdb_smoke.yaml --milvus-uri %DATA_DIR%\milvus_lite.db %GATE%
set "RC=%ERRORLEVEL%"
