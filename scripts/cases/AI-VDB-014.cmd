@echo off
REM ============================================================
REM  AI-VDB-014  HNSW  - run this script directly
...
"%PY%" -m full_test_plan_cases.run_case AI-VDB-014 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-vdb-014 %EXTRA%
set "RC=%ERRORLEVEL%"
endlocal & exit /b %RC%
