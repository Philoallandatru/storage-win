...
set "DATA_DIR=G:\MLPerfStorageTest\data\AI-TRN-004-2TB"
set "RESULT_DIR=G:\MLPerfStorageTest\results\AI-TRN-004-2TB"

echo [%~n0] data-dir=%DATA_DIR%  results-dir=%RESULT_DIR%
"%PY%" -m full_test_plan_cases.run_case AI-TRN-004-2TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-trn-004-2tb --num-files-train 8 --allow-invalid-params --client-memory-gb 64
set "RC=%ERRORLEVEL%"
