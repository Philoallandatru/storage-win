@echo off
REM ============================================================
REM  AI-VDB-001-4TB  1Kx128 HNSW  - run this script directly
...
"%PY%" -m full_test_plan_cases.run_case AI-VDB-001-4TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-vdb-001-4tb --num-vectors 100 --duration-sec 10 --vdb-config %REPO_ROOT%\full_test_plan_cases\configs\vdb_smoke.yaml --milvus-uri %DATA_DIR%\milvus_lite.db %GATE%
set "RC=%ERRORLEVEL%"
