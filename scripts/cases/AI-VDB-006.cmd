...
set "DATA_DIR=G:\MLPerfStorageTest\data\AI-VDB-006"
set "RESULT_DIR=D:\MLPerfStorageTest\results\AI-VDB-006"

echo [%~n0] data-dir=%DATA_DIR%  results-dir=%RESULT_DIR%
"%PY%" -m full_test_plan_cases.run_case AI-VDB-006 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-vdb-006 --num-vectors 100 --duration-sec 10 --vdb-config C:\Users\Administrator\Documents\Code\repos\storage\full_test_plan_cases\configs\vdb_smoke.yaml --milvus-uri %DATA_DIR%\milvus_lite.db
set "RC=%ERRORLEVEL%"
