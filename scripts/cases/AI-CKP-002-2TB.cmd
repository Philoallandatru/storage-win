...
set "DATA_DIR=G:\MLPerfStorageTest\data\AI-CKP-002-2TB"
set "RESULT_DIR=G:\MLPerfStorageTest\results\AI-CKP-002-2TB"

echo [%~n0] data-dir=%DATA_DIR%  results-dir=%RESULT_DIR%
"%PY%" -m full_test_plan_cases.run_case AI-CKP-002-2TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-002-2tb --num-processes 8 --allow-invalid-params --client-memory-gb 64
set "RC=%ERRORLEVEL%"
