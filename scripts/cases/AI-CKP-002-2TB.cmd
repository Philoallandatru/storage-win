@echo off
REM ============================================================
REM  AI-CKP-002-2TB  Llama3-70B 8-rank subset  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-CKP-002-2TB"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-CKP-002-2TB"
...
"%PY%" -m full_test_plan_cases.run_case AI-CKP-002-2TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-002-2tb --num-processes 8 --allow-invalid-params --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
