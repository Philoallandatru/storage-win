@echo off
REM ============================================================
REM  AI-KV-004-1TB  capacity  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-KV-004-1TB"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-KV-004-1TB"
...
"%PY%" -m full_test_plan_cases.run_case AI-KV-004-1TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-kv-004-1tb --num-users 10 --duration-sec 10 --trials 1 --inter-option-delay 0 --generation-mode fast --cpu-mem-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
