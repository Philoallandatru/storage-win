@echo off
REM ============================================================
REM  AI-TRN-005  RetinaNet/MI355  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-TRN-005"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-TRN-005"
...
"%PY%" -m full_test_plan_cases.run_case AI-TRN-005 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-trn-005 --num-files-train 8 --allow-invalid-params --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
