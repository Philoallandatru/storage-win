...
set "DATA_DIR=G:\MLPerfStorageTest\data\AI-TRN-005"
set "RESULT_DIR=D:\MLPerfStorageTest\results\AI-TRN-005"

echo [%~n0] data-dir=%DATA_DIR%  results-dir=%RESULT_DIR%
"%PY%" -m full_test_plan_cases.run_case AI-TRN-005 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-trn-005 --num-files-train 8 --allow-invalid-params --client-memory-gb 64
set "RC=%ERRORLEVEL%"
