...
set "DATA_DIR=G:\MLPerfStorageTest\data\AI-TRN-DLRM-1TB"
set "RESULT_DIR=G:\MLPerfStorageTest\results\AI-TRN-DLRM-1TB"

echo [%~n0] data-dir=%DATA_DIR%  results-dir=%RESULT_DIR%
"%PY%" -m full_test_plan_cases.run_case AI-TRN-DLRM-1TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-trn-dlrm-1tb --num-files-train 8 --allow-invalid-params --exec-type single --client-memory-gb 64
set "RC=%ERRORLEVEL%"
