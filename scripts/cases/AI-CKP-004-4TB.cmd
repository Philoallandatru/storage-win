@echo off
REM ============================================================
REM  AI-CKP-004-4TB  Llama3-405B 8-rank subset  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-CKP-004-4TB"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-CKP-004-4TB"
...
"%PY%" -m full_test_plan_cases.run_case AI-CKP-004-4TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-004-4tb --num-processes 8 --allow-invalid-params --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
