@echo off
REM ============================================================
REM  AI-TRN-DLRM-4TB  DLRM/B200  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-TRN-DLRM-4TB"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-TRN-DLRM-4TB"
...
"%PY%" -m full_test_plan_cases.run_case AI-TRN-DLRM-4TB --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-trn-dlrm-4tb --num-files-train 8 --allow-invalid-params --exec-type single --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
