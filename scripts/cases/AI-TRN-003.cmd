@echo off
REM ============================================================
REM  AI-TRN-003  UNet3D/B200  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-TRN-003"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-TRN-003"
...
"%PY%" -m full_test_plan_cases.run_case AI-TRN-003 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-trn-003 --num-files-train 8 --allow-invalid-params --client-memory-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
