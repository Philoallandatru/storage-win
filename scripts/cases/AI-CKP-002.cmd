@echo off
REM ============================================================
REM  AI-CKP-002  llama3-70b  - run this script directly
...
"%PY%" -m full_test_plan_cases.run_case AI-CKP-002 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-ckp-002 %EXTRA%
set "RC=%ERRORLEVEL%"
endlocal & exit /b %RC%
