@echo off
REM ============================================================
REM  AI-KV-007  Llama3.1-8B load curve  - run this script directly
...
set "DATA_DIR=C:\MLPerfStorageTest\data\AI-KV-007"
set "RESULT_DIR=C:\MLPerfStorageTest\results\AI-KV-007"
...
"%PY%" -m full_test_plan_cases.run_case AI-KV-007 --mode execute --data-dir "%DATA_DIR%" --results-dir "%RESULT_DIR%" --systemname ai-kv-007 --num-users 10 --duration-sec 10 --trials 1 --inter-option-delay 0 --generation-mode fast --cpu-mem-gb 64 %GATE%
set "RC=%ERRORLEVEL%"
